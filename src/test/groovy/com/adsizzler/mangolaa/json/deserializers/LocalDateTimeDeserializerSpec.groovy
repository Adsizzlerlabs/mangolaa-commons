package com.adsizzler.mangolaa.json.deserializers

import com.adsizzler.BaseSpec
import com.adsizzler.mangolaa.json.jackson.deserializers.LocalDateTimeDeserializer
...
class LocalDateTimeDeserializerSpec extends BaseSpec {
    ...
    def "Test out various date values. JsonDeserializer should convert string values to their LocalDate representation "(){
        ...
        then :
            ...
            '2017-04-04 11:11:11' |  LocalDateTime.of(LocalDate.of(2017,4,4),LocalTime.of(11,11,11))
            '2017-09-23 01:11:11' |  LocalDateTime.of(LocalDate.of(2017,9,23),LocalTime.of(1,11,11))
            ''           | null
    }
